...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "dineshwbx@gmail.com",
      href: "mailto:dineshwbx@gmail.com",
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/dineshwbx",
      label: "GitHub",
      color: "hover:bg-gray-700",
    },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/dineshwbx/",
      label: "LinkedIn",
      color: "hover:bg-blue-600",
    },
    {
      icon: Mail,
      href: "https://twitter.com/dineshwbx",
      label: "Twitter",
