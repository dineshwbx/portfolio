...
const About = () => {
  ...
  const skills = [
    { name: "React / Python", level: 90, icon: Code2 },
    ...
    { name: "GSAP / Framer Motion", level: 80, icon: Box },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div ref={contentRef} className="space-y-5 md:space-y-6">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-light text-white leading-tight">
              I'm Dinesh, a <span className="text-blue-500">Developer</span>,{" "}
              <span className="text-purple-500">Designer</span>, &{" "}
              <span className="text-yellow-500">AI/ML Enthusiast</span>
            </h3>

            <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
              With over 1.5 years of experience in the digital space, I specialize 
              in bridging the gap between sophisticated design and complex technical 
            ...
            <div className="grid grid-cols-2 gap-3 pt-4">
              ...
              <div className="flex items-center space-x-2 text-gray-300 bg-white/5 p-2 rounded-lg border border-white/5">
                ...
                <span className="text-xs sm:text-sm">Interactive 3D</span>
              </div>
            </div>
          </div>
